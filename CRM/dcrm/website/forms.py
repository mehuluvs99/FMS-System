...
class AddRecord(forms.ModelForm):
    company_name = forms.CharField(required=True,widget=forms.widgets.TextInput(
        attrs={"placeholder": "Company Name", "class": "form-control"}), label="")
    mobile_no = forms.CharField(required=True, widget=forms.widgets.TextInput(
        attrs={"placeholder": "Mobile No", "class": "form-control"}), label="")
    email = forms.CharField(required=True, widget=forms.widgets.TextInput(
        attrs={"placeholder": "Email ID", "class": "form-control"}), label="")
    ...
    class Meta:
        model = Record
        fields = ('company_name', 'mobile_no', 'email', 'phone', 'address', 'city', 'state', 'zipcode')
...
class OrderForm(forms.ModelForm):
    ...
    mobile_no = forms.CharField(required=True, widget=forms.widgets.TextInput(attrs={"placeholder": "Mobile No", "class": "form-control"}), label="")
    email = forms.CharField(required=True, widget=forms.widgets.TextInput(attrs={"placeholder": "Email ID", "class": "form-control"}), label="")
